...
export default function Chat() {
  return (
    <div>
     <TitleEnd title="Chat with the User"   />
     <div className={style.chatWrapper}>
        <div className={style.chat}>
            ...
            <div className={style.chatInfoTextLeft}>
                ...
                <p> <span> Username</span>:morteza880</p>
                <p> <span>Since</span> :2024/02/30</p>
                <p> <span>Condition</span>  :shopper</p>
            </div>
...
<div className={style.chattext}>
      ...
      {textData.map(chat=>
         <div key={chat.id} className={`${style.chatForward} ${chat.id%2===0 ? style.left : style.right}`}>
         <p>{chat.text}</p>
